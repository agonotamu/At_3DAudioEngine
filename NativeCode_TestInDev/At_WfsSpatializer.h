...
#include "AudioPluginUtil.h" //modif mathias 07-26-2021
#include <stdio.h>
...
namespace Spatializer
{
    ...
    private:
        ...
        */
        ...
        RingBuffer<MAX_BUFFER_SIZE, float> m_pCircularDelayBuffer;//modif mathias 07-26-2021

#if DIRECTIVE_PLAYER
        //float m_pDelayMultiChannelBuffer[MAX_INPUT_CHANNEL][MAX_BUFFER_SIZE * 2];
        RingBuffer<MAX_BUFFER_SIZE, float> m_pCircularDelayMultiChannelBuffer[MAX_INPUT_CHANNEL];//modif mathias 07-26-2021
#endif
